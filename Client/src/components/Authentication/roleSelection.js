    ...
    <div className="container" style={{marginBottom:'180px'}}>
      ...
      <div className="row ">
        ...
        <div className="col-sm-4 ">
          <div className="card p-4  border border-dark font-weight-bold" style={{color:'#6D28D9'}}>
        ...
        <div className="col-sm-4 ">
          <div className="card p-3  border border-dark font-weight-bold" style={{color:'#6D28D9'}}>
            <div className="card-body">
