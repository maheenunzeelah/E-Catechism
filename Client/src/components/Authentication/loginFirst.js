 ...
 <MDBRow>
   ...
   <MDBCol md="6">
     <form onSubmit={this.props.handleSubmit(this.handleSubmit)} className="ui form error" style={{ color:" black", fontSize:'16px'}}>
       <p className="h4 text-center font-weight-bold " style={{ marginTop:"50px", marginBottom:"-60px" ,fontSize:'30px', color:'#6D28D9'}} >LOG IN</p>
   ...
   <div>
     ...
     <Field name="role" component={renderError} />
       ...
       <div className="text-center mt-4">
         <MDBBtn  id="StuNext" className="pink accent-2" type="submit" style={{marginBottom:"74px", color:"white" }} disabled={this.state.nextisDisabled}>
           Next
         </MDBBtn>
         <MDBBtn className="pink accent-2" type="submit" style={{marginBottom:"74px", color:"white"}} disabled={this.state.registerisDisabled}>
           Login
         </MDBBtn>
       </div>
     </div>
