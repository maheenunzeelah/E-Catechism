      ...
      return (
        ...
        <div >
          ...
          <div className="container">
            ...
            {/* groups list  */}
            <div id="Group" className="w3-container  w3-padding-16 " style={{ border: '1px solid #e5e7eb', backgroundColor: '#ffffff', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)', color: '#1f2937' }}>
              <br />
