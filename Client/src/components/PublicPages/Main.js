                ...
                <div className="container  mt-5 ">
                    <div className="row " >
                        <div className="containercol-lg-6 col-md-6  col-sm-12 " >
                            <div>
                                <h1 className="display-4 font-weight-bold" style={{color:'#6D28D9'}}>E-Catechism</h1>
                            ...
                            <div>
                                ...
                                <div style={{ marginTop: "50px" }}  >
                                    <h4 style={{color:"#6D28D9"}} > Create Custom Tests & Exams Online</h4>
                                   <ul className="list">
                                    <li><i className="fas fa-arrow-right mr-2" style={{color:'#6D28D9'}}></i> Secure & private</li>
                                    <li><i className="fas fa-arrow-right mr-2" style={{color:'#6D28D9'}}></i> Easy to define Test settings</li>
                                    <li><i className="fas fa-arrow-right mr-2" style={{color:'#6D28D9'}}></i> No software installations required</li>
                                    <li><i className="fas fa-arrow-right mr-2" style={{color:'#6D28D9'}}></i> Give Exams with public & private options</li>
                                    <li><i className="fas fa-arrow-right mr-2" style={{color:'#6D28D9'}}></i> Results automatically graded & viewable in real time</li>
                                    <li><i className="fas fa-arrow-right mr-2" style={{color:'#6D28D9'}}></i> PCs, Macs, iPad, iPhone, Android, Chromebook & more</li>
                                  </ul>
                                </div>
                                <br />
                            </div>
