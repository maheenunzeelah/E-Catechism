...
function Landing(props) {
  ...
  if (!isEmpty(props.groups)) {
      ...
      <div className="container mt-5 mb-5">
        {props.groups.map((group, i) => {
          ...
          return <div className="mb-5">
            <p className="small " style={{ fontSize: '17px', fontWeight: 'bold', color:'#6D28D9' }}><i className="fa fa-users fa-2x pr-3" style={{color:'#6D28D9'}}></i>{group.groupId.groupName}</p>
    ...
    <h3 style={{color:'#6D28D9'}}>No Test or Groups Found</h3>
