...
<div className="container"  >
    <form onSubmit={(e)=>this.handleSubmit(e)}  className="w3-container w3-padding-16   w3-leftbar  " style={{backgroundColor:"#ffffff", color:"#1f2937", border:"1px solid #e5e7eb"}} id="QuestionBank">
...
<br></br>
   ...
   <div className="w3-container w3-padding-16  w3-leftbar  " id="Questions" style={{backgroundColor:"#ffffff", color:"#1f2937", border:"1px solid #e5e7eb"}}>
